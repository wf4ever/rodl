 ...
 * 
 */
public class ResearchObjectStabilityFeedAggregationDispatcherJobTest extends AbstractUnitTest {
    ...
    public final void testExecute()
            throws JobExecutionException {
        ResearchObjectStabilityFeedAggregationDispatcherJob job = new ResearchObjectStabilityFeedAggregationDispatcherJob();
        ...
        for (JobDetail jobDetail : answer.getJobs().keySet()) {
            rosScheduled.add((URI) jobDetail.getJobDataMap().get(StabilityFeedAggregationJob.RESEARCH_OBJECT_URI));
        }
