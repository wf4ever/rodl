...
public class DLibraDataSource
{
	...
	/**
	 * Creates new publication in group publication.<p>
	 * If basePublicationName is not null, then new publication
	 *  is a copy of base publication
	 */
		...
		throws DLibraException, IOException, TransformerException
	{
...

		{
			...
			for (PublicationInfo p : list) {
				regenerateManifest(groupPublicationName, p.getLabel(),
					versionUri, getManifest(groupPublicationName, p.getLabel()));
			}
		}
	}
