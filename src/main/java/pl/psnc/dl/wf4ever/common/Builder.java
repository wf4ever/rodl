...
public class Builder {
    ...
    public FolderEntry buildFolderEntry(AggregatedResource aggregatedResource, Aggregation proxyIn, String name) {
        FolderEntry entry = new FolderEntry(user, dataset, useTransactions, null);
