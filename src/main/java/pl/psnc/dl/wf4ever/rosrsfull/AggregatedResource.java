...
public class AggregatedResource {
    ...
    public Response getResourceTurtle(@PathParam("w_id") String workspaceId,
            @PathParam("ro_id") String researchObjectId, @PathParam("v_id") String versionId,
    ...
    public Response getResourceTrig(@PathParam("w_id") String workspaceId, @PathParam("ro_id") String researchObjectId,
            @PathParam("v_id") String versionId, @PathParam("filePath") String filePath,
            @DefaultValue("false") @QueryParam("content") boolean isContentRequested,
            @QueryParam("original") String original)
            throws ClassNotFoundException, IOException, TransformerException, DigitalLibraryException,
            NotFoundException, NamingException, SQLException, URISyntaxException {
    ...
    public Response getResourceTrix(@PathParam("w_id") String workspaceId, @PathParam("ro_id") String researchObjectId,
            @PathParam("v_id") String versionId, @PathParam("filePath") String filePath,
            @DefaultValue("false") @QueryParam("content") boolean isContentRequested,
            @QueryParam("original") String original)
            throws ClassNotFoundException, IOException, TransformerException, DigitalLibraryException,
    ...
    public Response getResourceN3(@PathParam("w_id") String workspaceId, @PathParam("ro_id") String researchObjectId,
            @PathParam("v_id") String versionId, @PathParam("filePath") String filePath,
            @DefaultValue("false") @QueryParam("content") boolean isContentRequested,
            @QueryParam("original") String original)
            throws ClassNotFoundException, IOException, TransformerException, DigitalLibraryException,
    ...
    public Response getResourceRdfXml(@PathParam("w_id") String workspaceId,
            @PathParam("ro_id") String researchObjectId, @PathParam("v_id") String versionId,
            @PathParam("filePath") String filePath,
            @DefaultValue("false") @QueryParam("content") boolean isContentRequested,
            @QueryParam("original") String original)
    ...
    @GET
    public Response getResourceAny(@PathParam("w_id") String workspaceId, @PathParam("ro_id") String researchObjectId,
            @PathParam("v_id") String versionId, @PathParam("filePath") String filePath,
            @DefaultValue("false") @QueryParam("content") boolean isContentRequested,
            @QueryParam("original") String original)
            throws ClassNotFoundException, IOException, TransformerException, DigitalLibraryException,
    ...
    private Response getResource(@PathParam("w_id") String workspaceId, @PathParam("ro_id") String researchObjectId,
            @PathParam("v_id") String versionId, @PathParam("filePath") String filePath,
            @DefaultValue("false") @QueryParam("content") boolean isContentRequested,
    ...
    public Response createOrUpdateFileTurtle(@PathParam("w_id") String workspaceId,
            @PathParam("ro_id") String researchObjectId, @PathParam("v_id") String versionId,
    ...
    public Response createOrUpdateFileTrig(@PathParam("w_id") String workspaceId,
            @PathParam("ro_id") String researchObjectId, @PathParam("v_id") String versionId,
            @PathParam("filePath") String filePath, @QueryParam("original") String original, InputStream data)
            throws ClassNotFoundException, AccessDeniedException, IOException, NamingException, SQLException,
            DigitalLibraryException, NotFoundException, URISyntaxException {
    ...
    public Response createOrUpdateFileTrix(@PathParam("w_id") String workspaceId,
            @PathParam("ro_id") String researchObjectId, @PathParam("v_id") String versionId,
            @PathParam("filePath") String filePath, @QueryParam("original") String original, InputStream data)
            throws ClassNotFoundException, AccessDeniedException, IOException, NamingException, SQLException,
            DigitalLibraryException, NotFoundException, URISyntaxException {
    ...
    public Response createOrUpdateFileN3(@PathParam("w_id") String workspaceId,
            @PathParam("ro_id") String researchObjectId, @PathParam("v_id") String versionId,
            @PathParam("filePath") String filePath, @QueryParam("original") String original, InputStream data)
            throws ClassNotFoundException, AccessDeniedException, IOException, NamingException, SQLException,
            DigitalLibraryException, NotFoundException, URISyntaxException {
    ...
    public Response createOrUpdateFileRdfXml(@PathParam("w_id") String workspaceId,
            @PathParam("ro_id") String researchObjectId, @PathParam("v_id") String versionId,
            @PathParam("filePath") String filePath, @QueryParam("original") String original, InputStream data)
            throws ClassNotFoundException, AccessDeniedException, IOException, NamingException, SQLException,
            DigitalLibraryException, NotFoundException, URISyntaxException {
    ...
    @PUT
    public Response createOrUpdateFileAny(@PathParam("w_id") String workspaceId,
            @PathParam("ro_id") String researchObjectId, @PathParam("v_id") String versionId,
            @PathParam("filePath") String filePath, @QueryParam("original") String original, InputStream data)
            throws ClassNotFoundException, AccessDeniedException, IOException, NamingException, SQLException,
            DigitalLibraryException, NotFoundException, URISyntaxException {
    ...
    @DELETE
    public void deleteFileAny(@PathParam("w_id") String workspaceId, @PathParam("ro_id") String researchObjectId,
            @PathParam("v_id") String versionId, @PathParam("filePath") String filePath,
            @QueryParam("original") String original)
    ...
    @DELETE
    @Consumes("application/rdf+xml")
    public void deleteFileRdfXml(@PathParam("w_id") String workspaceId, @PathParam("ro_id") String researchObjectId,
            @PathParam("v_id") String versionId, @PathParam("filePath") String filePath,
            @QueryParam("original") String original)
            throws DigitalLibraryException, NotFoundException, ClassNotFoundException, IOException, NamingException,
            SQLException, URISyntaxException {
    ...
    @DELETE
    @Consumes({ "application/x-turtle", "text/turtle" })
    public void deleteFileTurtle(@PathParam("w_id") String workspaceId, @PathParam("ro_id") String researchObjectId,
            @PathParam("v_id") String versionId, @PathParam("filePath") String filePath,
            @QueryParam("original") String original)
            throws DigitalLibraryException, NotFoundException, ClassNotFoundException, IOException, NamingException,
            SQLException, URISyntaxException {
    ...
    @DELETE
    @Consumes("application/x-trig")
    public void deleteFileTrig(@PathParam("w_id") String workspaceId, @PathParam("ro_id") String researchObjectId,
            @PathParam("v_id") String versionId, @PathParam("filePath") String filePath,
            @QueryParam("original") String original)
            throws DigitalLibraryException, NotFoundException, ClassNotFoundException, IOException, NamingException,
            SQLException, URISyntaxException {
    ...
    @DELETE
    @Consumes("application/trix")
    public void deleteFileTrix(@PathParam("w_id") String workspaceId, @PathParam("ro_id") String researchObjectId,
            @PathParam("v_id") String versionId, @PathParam("filePath") String filePath,
            @QueryParam("original") String original)
            throws DigitalLibraryException, NotFoundException, ClassNotFoundException, IOException, NamingException,
            SQLException, URISyntaxException {
    ...
    @DELETE
    @Consumes("text/rdf+n3")
    public void deleteFileN3(@PathParam("w_id") String workspaceId, @PathParam("ro_id") String researchObjectId,
            @PathParam("v_id") String versionId, @PathParam("filePath") String filePath,
            @QueryParam("original") String original)
            throws DigitalLibraryException, NotFoundException, ClassNotFoundException, IOException, NamingException,
            SQLException, URISyntaxException {
    ...
    private void deleteFile(@PathParam("w_id") String workspaceId, @PathParam("ro_id") String researchObjectId,
            @PathParam("v_id") String versionId, @PathParam("filePath") String filePath, String original,
            RDFFormat format)
            throws DigitalLibraryException, NotFoundException, ClassNotFoundException, IOException, NamingException,
            SQLException, URISyntaxException {
        UserProfile user = (UserProfile) request.getAttribute(Constants.USER);
