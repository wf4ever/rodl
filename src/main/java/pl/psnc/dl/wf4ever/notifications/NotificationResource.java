...
public class NotificationResource {
	...
	public Response getAtomFeeds(@Context UriInfo uriInfo, @QueryParam("ro") URI roUri,
			...
			@QueryParam("source") URI source, @QueryParam("limit") Integer limit) {
		...
		NotificationFeed atomFeed = new NotificationFeed.Builder(id).title(title).entries(entries)
				.build();
	...
	public Response deleteAtomFeeds(@QueryParam("ro") URI roUri, @QueryParam("from") Date from,
			@QueryParam("to") Date to, @QueryParam("source") URI source,
