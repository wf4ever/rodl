...
/**
 * Represents a simple entry of the feed, contains a simple report of the event
 * like update, damage and so on.
 * 
 * @author pejot
 */
@Entity
...
public class Notification implements Serializable {
	...
	/**
	 * The original id generated by source if entry comes from external service.
	 */
	 ...
	 * 
	 * @param feedUri
	 *            the URI of this feed, used for example for resolving relative
	 *            URIs
	...
	public Entry asFeedEntry(URI feedUri) {
		...
		htmlContent.setValue(summary);
		htmlContent.setType(Content.HTML);
		resultEntry.setContents(Arrays.asList(htmlContent));
		// set links
		List<Link> links = new ArrayList<>();
		/*
		 * if (source != null) { Link sourceLink = new Link();
		 * sourceLink.setHref(feedUri != null ?
		 * feedUri.resolve(source).toString() : source .toString());
		 * sourceLink.setRel(DCTerms.source.toString()); if (sourceName != null)
		 * { sourceLink.setTitle(sourceName); } else {
		 * sourceLink.setTitle(source); } links.add(sourceLink); }
		 */
	...
	/**
	 * A builder class that allows to create a {@link Notification} using the
	...
	public static class Title {
		...
		public static String checksumMismatch(ResearchObject researchObject) {
			return String
					.format("Research Object %s has become corrupt!", researchObject.getName());
		}
	}
	...
	public static class Summary {
		...
		public static String created(ResearchObject researchObject) {
			return wrap(String
					.format("<p>A new Research Object has been created.</p><p>The Research Object URI is <a href=\"%s\">%<s</a>.</p>",
		...
		public static String deleted(ResearchObject researchObject) {
			return wrap(String
					.format("<p>A Research Object has been deleted.</p><p>The Research Object URI was <em>%s</em>.</p>",
							researchObject.toString()));
		}
		...
		public static String created(ResearchObjectComponentSerializable component) {
			return wrap(String
					.format("<p>A resource has been added to the Research Object.</p><ul><li>The Research Object: <a href=\"%s\">%<s</a>.</li><li>The resource: <a href=\"%s\">%<s</a>.</li></ul>",
		...
		public static String deleted(ResearchObjectComponentSerializable component) {
			return wrap(String
					.format("<p>A resource has been deleted from the Research Object.</p><ul><li>The Research Object: <a href=\"%s\">%<s</a>.</li><li>The resource: <em>%s</em>.</li></ul>",
							component.getResearchObject().getUri().toString(), component.getUri()
									.toString()));
		}
		 ...
		 */
		public static String checksumMismatch(ResearchObject researchObject,
				Collection<Mismatch> mismatches) {
			StringBuilder sb = new StringBuilder();
			sb.append("<p>The following changes have been detected:</p>");
			sb.append("<ol>");
			for (Mismatch mismatch : mismatches) {
				sb.append(String.format("<li>File %s: expected checksum %s, found %s</li>",
						mismatch.getResourcePath(), mismatch.getExpectedChecksum(),
						mismatch.getCalculatedChecksum()));
			}
			sb.append("</ol>");
